...
<#
    ...
    C:\PS> $request,$session = Send-EXOSrpc -ip "10.1.1.1" -cmd "show vlan" -cred (Get-Credential)
    C:\PS> $request
        StatusCode        : 200
    ...
    C:\PS> $request = Send-EXOSrpc -ip "10.1.1.1" -cmd "show vlan" -session $session
    C:\PS> $request
        StatusCode        : 200
        StatusDescription : OK
        Content           : {
